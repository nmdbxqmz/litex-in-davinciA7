	...
	with_video_framebuffer = False,
        ...
        **kwargs):
        ...
        self.crg  = _CRG(platform, sys_clk_freq, with_dram, with_rst=True, with_ethernet=with_ethernet, with_etherbone=with_etherbone,
                         with_video_terminal=with_video_terminal, with_video_framebuffer=with_video_framebuffer)
        ...
        # use for test
        self.gpio = GPIOTristate(
                pads     = platform.request_all("gpio"),
                with_irq = self.irq.enabled
            )
...
def main():
    ...
    parser = LiteXArgumentParser(platform=alientek_davinci.Platform, description="LiteX SoC on Arty A7.")
